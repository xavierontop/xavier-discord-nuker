...
input(" Welcome To Sanitary Nuker v2 \nPress Enter To Continue Nuking; ")
time.sleep(0.1)
...
while True:
    if code == "Xavier lol":
        ...
        print("Password Is Invalid Restart The Program! \n")
...
class rex:
        ...
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.CYAN}Banned {Fore.GREEN}{member.strip()} {Fore.GREEN}")
                    break
                else:
                    break
    def KickMembers(self, guild, member):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}Successfully Banned {Fore.GREEN}{member.strip()}")
                    break
                else:
                    break
    ...
    def DeleteChannels(self, guild, channel):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}Deleted Channel {Fore.GREEN}{channel.strip()}")
                    break
                else:
                    break
    ...
    def DeleteRoles(self, guild, role):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}Role Deleted {Fore.GREEN}{role.strip()}")
                    break
                else:
                    break
    ...
    def SpamChannels(self, guild, name):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}Created Channel {Fore.GREEN}{name}")
                    break
                else:
                    break
    ...
    def SpamRoles(self, guild, name):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}Created Role {Fore.GREEN} {name}")
                    break
                else:
                    break
        ...
        while True:
            ...
            if r.status_code == 429:
                ...
                if r.status_code == 204 or 201 or 200:
                    print(f"{Fore.RED}Sent message {Fore.GREEN} {message}")
                    break
                else:
                    break
    ...
    async def SpamWebhook(self, guild_id, amount, message):
        ...
        for channel in guild.text_channels:
            try:
                webhook = await channel.create_webhook(name='Aztec!!', reason="youtube - LuvAztec")
                print(f"{Fore.RED}Spammed")
    ...
    async def Scrape(self):
        guild = input(f'{Fore.RED}Server Id: {Fore.GREEN}')
        ...
        with open('members.txt', 'a') as m:
            for member in members:
                ...
                membercount += 1
            print(f"\n {Fore.GREEN}Server has {Fore.GREEN}{membercount} Members")
            m.close()

        channelcount = 0
        with open('channels.txt', 'a') as c:
            for channel in guildOBJ.channels:
                c.write(str(channel.id) + "\n")
                channelcount += 1
            print(f"{Fore.GREEN}Scrapped {Fore.GREEN}{channelcount} Channels")
            c.close()

        rolecount = 0
        with open('roles.txt', 'a') as r:
            for role in guildOBJ.roles:
                r.write(str(role.id) + "\n")
                rolecount += 1
            print(f"{Fore.GREEN}Scrapped {Fore.GREEN}{rolecount} Roles")
            r.close()

    async def NukeExecute(self):
        guild = input(f'{Fore.GREEN}Server Id: {Fore.GREEN}')
        channel_name = input(f"{Fore.GREEN}Channels Name: {Fore.GREEN}")
        channel_amount = input(f"{Fore.GREEN}How Many?: {Fore.GREEN}")
        role_name = input(f"{Fore.GREEN}Roles Name: {Fore.GREEN}")
        role_amount = input(f"{Fore.GREEN}How Many?: {Fore.GREEN}")
        print()
    ...
    async def ChannelSpamExecute(self):
        guild = input(f' {Fore.GREEN}Server Id: {Fore.GREEN}')
        name = input(f"{Fore.GREEN}Channel Name:: {Fore.GREEN}")
        amount = input(f"{Fore.GREEN}How Many?: {Fore.GREEN}")
        print()
    ...
    async def RoleSpamExecute(self):
        guild = input(f'{Fore.RED}Server Id: {Fore.GREEN}')
        name = input(f"{Fore.RED}Role Name: {Fore.GREEN}")
        amount = input(f"{Fore.RED}How Many?: {Fore.GREEN}")
        print()
        for i in range(int(amount)):
...
''')
    ...
    async def Menu(self):
        ...
        print(f'''
                             {Fore.CYAN} Made by aztec#6927
                                       ...
                                       _____             _ _                   
                                      / ____|           (_) |                  
                                      | (___   __ _ _ __  _| |_ __ _ _ __ _   _ 
                                      \___ \ / _` | '_ \| | __/ _` | '__| | | |
                                       ____) | (_| | | | | | || (_| | |  | |_| |
                                      |_____/ \__,_|_| |_|_|\__\__,_|_|   \__, |
                                                                          __/  |
                                                                          |___/ 
                                                    1 = Scrape Guild 
                                                    2 = Ban Em Down
                                                    ...
                                                    9 = Channel Spam
        ''')
        await client.change_presence(activity=discord.Game(name="klutz cant get caught"))

        choice = input(f'{Fore.RED}Number: {Fore.GREEN}')
        if choice == '2': #bans
            ...
            amount = int(input(f"{Fore.RED}How Many?: {Fore.GREEN}"))
            guild_id = int(input(f"{Fore.RED}Server Id: {Fore.GREEN}"))
            message = str(input(f"{Fore.RED}Webhook Message: {Fore.GREEN}"))
    ...
    def Startup(self):
        try:
            ...
            print(f'{Fore.RED}Token Was Invalid {Fore.GREEN}')
            input()
            os._exit(0)
